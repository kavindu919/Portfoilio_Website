...
export const Data = () => {
  return (
    <div className="home_data">
        ...
        <h3 className="home_subtitle">I'm Kavindu Jayakody</h3>
        <p className="home_description">I'm creative Developer based on Negombo, and I'm very passionate and dedicated to my work.</p>
